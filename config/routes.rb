ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :trip_enrollments

  map.resources :trips

  map.resources :payments
  
  map.resources :content_administration
  ...
  # this makes no sense since there is no actual db behind this, all this does is show. 
